			...
			<div className="quienes-somos">
                <Grid container>
                    <Grid item xs={12} md={6} className="title">
                        <img data-aos="zoom-in" data-aos-offset="350" data-aos-duration="1000" src="/public/img/elementos/titulo_quienes-somos.png" />
                    </Grid>
                    <Grid item xs={12} md={6} className="info primary-text">
                        <div className="dulces-img">
                            <img data-aos="flip-left" data-aos-offset="350"  data-aos-duration="1000" src="/public/img/elementos/dulces_quienes-somos.png" alt=""/>
                        </div>
                        <div className="dulces-text">
                            <p data-aos="zoom-in" data-aos-offset="350" data-aos-duration="1000">
